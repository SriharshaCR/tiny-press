...
💻 Try @ [tiny-press](https://huggingface.co/spaces/build-small-hackathon/tiny-press)

👩‍💻Notebook @ [tinypress_colab.ipynb](https://colab.research.google.com/github/SriharshaCR/tiny-press/blob/task/bootstrap/tinypress_colab.ipynb)
